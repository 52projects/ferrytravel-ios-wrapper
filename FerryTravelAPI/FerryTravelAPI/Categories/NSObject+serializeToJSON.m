...
- (NSString *)cleanseValue:(id)value field:(NSString *)fieldName {
	...
	if ([value isKindOfClass:[NSNull class]] || value == nil) {
		...
		return [NSString stringWithFormat:@"%@", [FTDateUtility stringFromDate:value withDateFormat:@"yyyy-MM-dd'T'HH:mm:ss"]];
	}
		...
		else if ([[NSString stringWithFormat:@"%d", [value integerValue]] isEqualToString:[NSString stringWithFormat:@"%ld", NSIntegerMin]]) {
			return @"";
		}
		else {
			return [NSString stringWithFormat:@"%d", [value integerValue]];
