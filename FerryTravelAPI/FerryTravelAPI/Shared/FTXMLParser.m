...
@interface FTXMLParser (Internal)
...
+ (NSDictionary *)dictionaryForPath:(NSString *)path error:(NSError **)errorPointer
{
    ...
    NSDictionary *rootDictionary = [FTXMLParser dictionaryForXMLData:data error:errorPointer];
...
{
    FTXMLParser *reader = [[FTXMLParser alloc] initWithError:error];
...
+ (NSDictionary *)dictionaryForXMLString:(NSString *)string error:(NSError **)error
{
    ...
    return [FTXMLParser dictionaryForXMLData:data error:error];
}
